%**************************************************************************
%
% # $Id: TissueDrawingTest.Rnw 80 2013-07-24 22:13:34Z js229 $
...
\section{addSetToDrawing  two polygons}
...
@
 \end{center}\end{figure}
%##################
\section{addSetToDrawing  a polygon and a circle}
...
Author & Jonathan Swinton
\\
SVN id of this document & ${}$Id: TissueDrawingTest.Rnw 80 2013-07-24 22:13:34Z js229 ${}$.
\\
Generated on & \today
\\
R version & 
